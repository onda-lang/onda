...
7. Call `onda_processor_init(params, state, ONDA_PROCESSOR_INIT_FULL, buffers, buffer_frames,
   buffer_channels, buffer_sample_rates, output)` once and reject a nonzero execution status.
