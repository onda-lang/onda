class OmniSineProcessor extends AudioWorkletProcessor {
  constructor(options) {
    super();
    ...
    this.exports.omni_init(this.paramsPtr, this.statePtr);
  }
...
registerProcessor("omni-sine-processor", OmniSineProcessor);
