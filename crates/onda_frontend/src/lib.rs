...
pub use ast::{
    ...
    GraphEndpoint, GraphRate, InitBlock, LogicalOp, NamespaceAliasDecl, NamespaceCallArg,
    NamespaceDecl, NamespaceItem, NamespaceRefSegment, NamespaceTemplateParam, OutputTiming,
    ParamBlock, ParamControl, ParamDecl, ParamScale, PortBlock, PortDecl, PrimitiveType,
    PrintSourceOrigin, ProcessorDef, Program, SampleBlock, ScalarTypeRef, SourceLoc, Span, Stmt,
    StructDef, StructField, TaskDef, TupleAssignTarget, UseDecl, WhenBinding, WhenDef, WhenTarget,
    ...
    METHOD_RECEIVER_ARG, PARAM_DOMAIN_FIELDS, PARAM_DOMAIN_POSITIONAL_FIELDS, PARAM_SCALES,
...
pub use parser::{
    ...
    normalize_path_lexically, parse_namespace_ref_text_ast, parse_program, parse_program_file,
