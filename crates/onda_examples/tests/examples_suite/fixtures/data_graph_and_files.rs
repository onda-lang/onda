...
const PROC_GAIN_GRAPH_FILE_EXAMPLE: &str =
    include_str!("../../../../../examples/proc_gain_graph.onda");
const PROC_SPLIT_GRAPH_FILE_EXAMPLE: &str =
    include_str!("../../../../../examples/proc_split_graph.onda");
