...
#[derive(Debug, Clone)]
pub(crate) struct StateLayoutEntry {
...
#[derive(Debug, Clone)]
pub(crate) struct ArrayLayoutEntry {
    pub(crate) name: String,
...
pub(crate) fn primitive_size_align(ty: PrimitiveType) -> (usize, usize) {
    match ty {
...
pub(crate) fn compute_arrays_layout(
    typed: &TypedProgram,
...
pub(crate) fn state_total_size_bytes(
...
pub(crate) fn arrays_layout_map(
